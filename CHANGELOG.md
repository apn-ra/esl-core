...
- Added `docs/downstream-integration.md` as one concise downstream integration note covering the preferred composition path, accepted-stream bootstrap, preferred vs advanced vs internal seams, and the runtime responsibilities that still belong in `esl-react`.
