...
final class CapabilityMap implements CapabilityMapInterface
{
    ...
    private static array $capabilities = [
        ...
        'native-replay-adjacent-semantics' => FeatureSupportLevel::Stable,
        'queue-retry-drain-vocabulary'  => FeatureSupportLevel::Stable,
        'terminal-publication-schema'   => FeatureSupportLevel::Stable,
        'lifecycle-semantic-contract'   => FeatureSupportLevel::Stable,
        'corpus-row-identity'           => FeatureSupportLevel::Stable,
        'bounded-variance-markers'      => FeatureSupportLevel::Stable,
